...
import { idlFactory } from './basic.did.js';
export { idlFactory } from './basic.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_BASIC;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./basic.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the basic canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./basic.did.js")._SERVICE>}
 */
export const basic = createActor(canisterId);
